            ...
            "examples": [
                {
                    ...
                    "idempotency_key": "123e4567-e89b-12d3-a456-426614174000:ab12cd34ef56gh78ij90kl12",
...
class HealthCheckResponse(BaseModel):
    ...
    checks: dict[str, Any] | None = Field(default=None, description="Individual service checks")
...
class ReconciliationResponse(BaseModel):
    ...
    discrepancies: list[dict[str, Any]] = Field(
        ...,
        description="List of specific discrepancies",
    )